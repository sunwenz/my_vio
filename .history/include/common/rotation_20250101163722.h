...
class Rotation{
public:
    static Eigen::Matrix3d Angles2DCM(const Eigen::Vector3d& Attitude)
    {
    ...
    static Eigen::Vector3d DCM2Angles(const Eigen::Matrix3d& DCM)
    {
    ...
    */
    /*------------------------------------------------------------------------*/
    static Eigen::Matrix3d AntimetricM(const Eigen::Vector3d& Pusy)
    {
