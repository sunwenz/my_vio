...
public:
    ...
    */
    /*------------------------------------------------------------------------*/
    Mat33 AntimetricM(Eigen::Vector3d Pusy);
    ...
    */
    /*------------------------------------------------------------------------*/
    Eigen::Vector3d Cross(Eigen::Vector3d A, Eigen::Vector3d B);
    ...
    */
    ...
    Mat33 DRi(const Eigen::Vector3d &blh);

    Mat33 DR(const Eigen::Vector3d &blh);

    Mat33 DR_ned(const Eigen::Vector3d &blh);

    Eigen::Vector3d uvw2enu(double u, double v, double w, double lat0, double lon0);

    Eigen::Vector3d geodetic2enu(const Eigen::Vector3d &xyz, const Eigen::Vector3d &xyz0);
    ...
    Mat33 cne(const Eigen::Vector3d &blh);
